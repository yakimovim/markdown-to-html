...
{
    public class CodeProjectHtmlBuilderTests
    {
        private readonly MarkdownConverter _converter;

        public CodeProjectHtmlBuilderTests()
        {
            _converter = new MarkdownConverter(new CodeProjectHtmlBuilder());
        }
        ...
        public void Paragraph()
        {
            ...
            html.Should().Be($"<p>This is a paragraph text</p>{Environment.NewLine}");
        }
        ...
        public void Italic(char symbol)
        {
            ...
            html.Should().Be($"<p>This is a <i>paragraph</i> text</p>{Environment.NewLine}");
        }
        ...
        public void Bold(char symbol)
        {
            ...
            html.Should().Be($"<p>This is a <b>paragraph</b> text</p>{Environment.NewLine}");
        }
        ...
        public void Strikethrough()
        {
            ...
            html.Should().Be($"<p>This is a <s>paragraph</s> text</p>{Environment.NewLine}");
        }
        ...
        public void InlineCode()
        {
            ...
            html.Should().Be($"<p>This is a <code>paragraph</code> text</p>{Environment.NewLine}");
        }
        ...
        public void Headers(int level)
        {
            ...
            html.Should().Be($"<h{level}>This is a header</h{level}>{Environment.NewLine}");
        }
        ...
        public void Link()
        {
            ...
            html.Should().Be($"<p>This is a <a href='https://www.example.com' rel='nofollow' target='_blank'>link</a> text</p>{Environment.NewLine}");
        }
